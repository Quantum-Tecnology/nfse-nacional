...
/**
 * De-para de codigo IBGE -> [nome do municipio, UF].
 *
 * Why: o XML da NFS-e traz apenas `cMun` (codigo IBGE) em `enderNac`/`endNac`.
 * Para o TOMADOR o nome nao vem em lugar nenhum do documento, e o DANFSe
 * oficial imprime "Campinas - SP" — logo a resolucao tem de acontecer aqui.
 * Para o emitente existe `xLocEmi`, mas usar a mesma fonte mantem o formato
 * consistente entre todos os campos de municipio do documento.
 *
 * Fonte: API oficial do IBGE
 * (servicodados.ibge.gov.br/api/v1/localidades/municipios) — 5571 municipios.
 *
